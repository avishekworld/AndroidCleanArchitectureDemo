...
class NavigationViewModel(private val context: Context) : ViewModel() {
            ...
            state.copy(
                viewState = state.viewState.copy(
                    mapState = NavigationMapState.Show(
                        ...
                        mapClickListener = {
                            mapLatLongClicked ->
                            handleEvent(Event.MapPointClicked(mapLatLongClicked))
                        }
                    )
                )
            )
    ...
    private data class InternalState(
        val mapPointSelectedList: List<LatLng> = emptyList(),
    ...
    data class ViewState(
        val mapState: NavigationMapState,
    ...
    sealed class NavigationMapState {
        ...
        data class Show(
            ...
            val mapClickListener: GoogleMap.OnMapClickListener
        ) : NavigationMapState()
    }
